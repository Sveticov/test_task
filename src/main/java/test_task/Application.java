...
//        department3.getEmployees().add(employee3_1);
        ...
        //todo test
        Department department4 = new Department("Test"); //todo test
        Employee employeeTB = new Employee(department4, null, "TB", new BigDecimal(0));
        Employee employeeT = new Employee(department4, employeeTB, "Test", new BigDecimal(67060));
        department4.setEmployees(new HashSet<>());
        department4.getEmployees().add(employeeT);
        department4.getEmployees().add(employeeTB);
